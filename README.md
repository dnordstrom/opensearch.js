...
2. Call `window.external.AddSearchProvider(url)` with the URL to a provider XML file. For the Startpage provider:<br><br>`window.external.AddSearchProvider("https://raw.github.com/dn...t.opensearch/master/startpage.xml");`<br>&nbsp;
